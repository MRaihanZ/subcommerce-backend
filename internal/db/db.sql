...
CREATE TABLE
    ratings (
        ...
        order_id INT CONSTRAINT fk_ra_order_id REFERENCES orders (id) ON DELETE CASCADE ON UPDATE CASCADE NOT NULL,
        CONSTRAINT uq_ra_product_product_variant_user_order UNIQUE (product_id, product_variant_id, user_id, order_id),
